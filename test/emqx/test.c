...
int curl_post_get(char *send_data, char *url)
{
    CURLcode res;
    CURL *curl; 
...
\":0}]}");
        ...
        printf("SJQ:%s\n\r", strcat(tmp_url,login_url));
				...
				curl_post_get("{\"password\":\"21232f297a57a5a743894a0e4a801fc3\",\"username\":\"21232f297a57a5a743894a0e4a801fc3\"}", tmp_url  );
				memset(tmp_url,0, sizeof(tmp_url));
        printf("SJQ:%s\n\r", strcat(tmp_url,local_ip));
        printf("SJQ:%s\n\r", strcat(tmp_url,login_status_url));
				curl_post_get("", tmp_url);
				memset(tmp_url,0, sizeof(tmp_url));
        printf("SJQ:%s\n\r", strcat(tmp_url,local_ip));
